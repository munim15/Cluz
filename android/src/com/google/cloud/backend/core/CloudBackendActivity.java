...
/**
 * An {@link android.app.Activity} class that wraps CloudBackend features including CRUD of
 ...
 * to inherit other {@link android.app.Activity} subclasses, you may rewrite the superclass
...
public class CloudBackendActivity extends FragmentActivity {
    ...
    /**
     * Handles broadcast messages from the com.google.cloud.backend. Subclasses may override this
     * to handle the message accordingly.
     *
     * @param message
     *          {@link com.google.cloud.backend.core.CloudEntity} that contains the message values.
     */
