...
/**
 * A query object to execute it with {@link com.google.cloud.backend.core.CloudBackend}. See
...
public class CloudQuery {
    ...
    /**
     * Creates an instance of {@link com.google.cloud.backend.core.CloudQuery}.
     *
    ...
    /**
     * Creates an instance of {@link com.google.cloud.backend.core.CloudQuery} from the values of the
     * specified CloudQuery. queryDto field will be deep copied, and filter
     * field will be shallow copied.
     *
     * @param cq {@link com.google.cloud.backend.core.CloudQuery} that will be used for instantiation.
     */
     ...
     * @return {@link com.google.cloud.backend.core.CloudQuery}
     */
    ...
    /**
     * Creates a {@link com.google.cloud.backend.android.mobilebackend.model.QueryDto} for this CloudQuery.
     *
     * @return {@link com.google.cloud.backend.android.mobilebackend.model.QueryDto} for this CloudQuery
     */
     ...
     * grouping multiple {@link com.google.cloud.backend.core.CloudQuery} as one query and map it to one
     * handler.
     *
     ...
     * multiple {@link com.google.cloud.backend.core.CloudQuery}s if they have the same query condition.
     * 
     * @return
     */
