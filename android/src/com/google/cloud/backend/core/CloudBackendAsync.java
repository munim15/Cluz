...
public class CloudBackendAsync extends CloudBackend {
    ...
    /**
     * {@link android.app.Application} for this com.google.cloud.backend object, such as {@link android.app.Activity}.
     */
    ...
    /**
     * Inserts a CloudEntity into the com.google.cloud.backend asynchronously.
     *
    ...
    public void insert(CloudEntity ce, CloudCallbackHandler<CloudEntity> handler) {
        (new BackendCaller<CloudEntity, CloudEntity>(ce, handler) {
            ...
            protected CloudEntity callBackend(CloudEntity param) throws IOException {
                return com.google.cloud.backend.core.CloudBackendAsync.super.insert(param);
            }
        }).start();
    }

    /**
     * Inserts multiple {@link com.google.cloud.backend.core.CloudEntity}s on the com.google.cloud.backend asynchronously.
    ...
    public void insertAll(
        ...
        (new BackendCaller<List<CloudEntity>, List<CloudEntity>>(ceList, handler) {
            ...
            protected List<CloudEntity> callBackend(List<CloudEntity> ceList) throws IOException {
                return com.google.cloud.backend.core.CloudBackendAsync.super.insertAll(ceList);
            }
        }).start();
    }

    /**
     * Updates the specified {@link com.google.cloud.backend.core.CloudEntity} on the com.google.cloud.backend asynchronously.
    ...
    public void update(CloudEntity ce, CloudCallbackHandler<CloudEntity> handler) {
        (new BackendCaller<CloudEntity, CloudEntity>(ce, handler) {
            @Override
            protected CloudEntity callBackend(CloudEntity param) throws IOException {
                return com.google.cloud.backend.core.CloudBackendAsync.super.update(param);
            }
        }).start();
    }

    /**
     * Updates multiple {@link com.google.cloud.backend.core.CloudEntity}s on the com.google.cloud.backend asynchronously.
    ...
    public void updateAll(
        ...
        (new BackendCaller<List<CloudEntity>, List<CloudEntity>>(ceList, handler) {
            @Override
            protected List<CloudEntity> callBackend(List<CloudEntity> ceList) throws IOException {
                return com.google.cloud.backend.core.CloudBackendAsync.super.updateAll(ceList);
            }
        }).start();
    }

    /**
     * Reads the specified {@link com.google.cloud.backend.core.CloudEntity} asynchronously.
     *
     * @param ce {@link com.google.cloud.backend.core.CloudEntity} that has kindName and id to specify the
     *            CloudEntity on the com.google.cloud.backend. Other property values will be
     *            ignored.
     * @param handler {@link com.google.cloud.backend.core.CloudCallbackHandler} that handles the response.
     */
    public void get(CloudEntity ce, CloudCallbackHandler<CloudEntity> handler) {
        (new BackendCaller<CloudEntity, CloudEntity>(ce, handler) {
            ...
            protected CloudEntity callBackend(CloudEntity ce) throws IOException {
                return com.google.cloud.backend.core.CloudBackendAsync.super.get(ce.getKindName(), ce.getId());
            }
        }).start();
    }

    /**
     * Reads the specified multiple {@link com.google.cloud.backend.core.CloudEntity}s asynchronously.
     *
     * @param ceList a List of {@link com.google.cloud.backend.core.CloudEntity}s that has kindName and id to
     *            specify the CloudEntity on the com.google.cloud.backend. Other property values
     *            will be ignored.
     * @param handler {@link com.google.cloud.backend.core.CloudCallbackHandler} that handles the response.
     */
    public void getAll(List<CloudEntity> ceList, CloudCallbackHandler<List<CloudEntity>> handler) {
        (new BackendCaller<List<CloudEntity>, List<CloudEntity>>(ceList, handler) {
            ...
            protected List<CloudEntity> callBackend(List<CloudEntity> ceList) throws IOException {
                ...
                return com.google.cloud.backend.core.CloudBackendAsync.super.getAll(idList.get(0), idList);
            }
        }).start();
    }

    /**
     * Deletes the specified {@link com.google.cloud.backend.core.CloudEntity} asynchronously.
     *
     * @param ce {@link com.google.cloud.backend.core.CloudEntity} that has kindName and id to specify the
     *            CloudEntity on the com.google.cloud.backend. Other property values will be
     *            ignored.
    ...
    public void delete(CloudEntity ce, CloudCallbackHandler<Void> handler) {
        (new BackendCaller<CloudEntity, Void>(ce, handler) {
            ...
            protected Void callBackend(CloudEntity ce) throws IOException {
                com.google.cloud.backend.core.CloudBackendAsync.super.delete(ce.getKindName(), ce.getId());
                return null;
            }
        }).start();
    }
    ...
    /**
     * Deletes the specified multiple {@link com.google.cloud.backend.core.CloudEntity}s asynchronously.
     *
     * @param ceList a List of {@link com.google.cloud.backend.core.CloudEntity}s that has kindName and id to
     *            specify the CloudEntity on the com.google.cloud.backend. Other property values
     *            will be ignored.
    ...
    public void deleteAll(
        ...
        (new BackendCaller<List<CloudEntity>, List<CloudEntity>>(ceList, handler) {
            ...
            protected List<CloudEntity> callBackend(List<CloudEntity> ceList) throws IOException {
                ...
                com.google.cloud.backend.core.CloudBackendAsync.super.deleteAllById(idList.get(0), idList);
                return null;
            }
        }).start();
    }
    ...
    private void _list(CloudQuery query, CloudCallbackHandler<List<CloudEntity>> handler,
        ...
        (new BackendCaller<CloudQuery, List<CloudEntity>>(query, handler, uiThreadHandler) {
            ...
            protected List<CloudEntity> callBackend(CloudQuery query) throws IOException {
                ...
                // execute query
                return com.google.cloud.backend.core.CloudBackendAsync.super.list(query);
            }
        }).start();
    }
     ...
     * @param order {@link com.google.cloud.backend.core.CloudQuery.Order} of sorting on the specified property (ignored
     *            when inequality filter is not used as the operator)
     * @param limit number of maximum entities to be returned
     * @param scope {@link com.google.cloud.backend.core.CloudQuery.Scope} of this query
     * @param handler {@link com.google.cloud.backend.core.CloudCallbackHandler} that handles the response.
     */
    public void listByProperty(String kindName, String propertyName, Filter.Op operator,
            Object propertyValue, Order order, int limit, Scope scope,
     ...
     * @param order {@link com.google.cloud.backend.core.CloudQuery.Order} of sorting on the specified property
     * @param limit number of maximum entities to be returned
     * @param scope {@link com.google.cloud.backend.core.CloudQuery.Scope} of this query
     * @param handler {@link com.google.cloud.backend.core.CloudCallbackHandler} that handles the response.
     */
    public void listByKind(String kindName, String sortPropertyName, Order order,
    ...
    // a Thread class that will call com.google.cloud.backend API asynchronously
